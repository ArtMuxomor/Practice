/*
	Скрипт создания БД в Microsoft SSMS
*/
...
CREATE TABLE [Character] (
	...
	, CharacterCreationTime DATETIME2 NOT NULL DEFAULT GETDATE()
...
/*
	1. Справочники
*/
INSERT INTO [Stat] (StatName) VALUES
	(N'Атака')
	, (N'ХП')
	, (N'Скорость')
	, (N'Крит')
...
*/
CREATE VIEW [Artifact_Total_Stat] AS
SELECT
	at.ArtifactTypeName
...
*/
CREATE VIEW [Character_Weapon_Stat] AS
SELECT
	C.CharacterName
...
FROM [Character] C
	LEFT JOIN
		[Character_Weapon] CW ON C.CharacterGuid = CW.CharacterGuid AND CW.IsEquipped = 1
	LEFT JOIN
		[Weapon] W ON CW.WeaponGuid = W.WeaponGuid
	LEFT JOIN
		[WeaponType] WT ON W.WeaponTypeId = WT.WeaponTypeId;
GO
